...
public class TankStar implements Screen, Serializable {
    ...
    public TankStar(Game g) {
        ...
        angle_left = new Texture("BlueRectangle.png");
        angle_right = new Texture("BlueRectangle.png");
        health_left = new Texture("OrangeRectangle.png");
        health_right = new Texture("OrangeRectangle.png");
    }
